...
facilities in question. */
            ...
            From Facilities 
            Where monthlymaintenance * .2 > membercost;
...
the member name. */
            ...
            SELECT DISTINCT concat_ws(' ', firstname, surname) as full_name, f.name AS facility         
            FROM Bookings AS b
...
Order by descending cost, and do not use any subqueries. */
            ...
            Select f.name, concat_ws(' ', firstname, surname) as member_name,
            CASE WHEN b.memid = 0
...
/* Q11: Produce a report of members and who recommended them in alphabetic surname,firstname order */
            ...
            """SELECT m.firstname || ' ' || m.surname, m.recommendedby
                    ...
                    SELECT m.firstname || ' ' || m.surname, m.recommendedby
                    FROM MEMBERS as m
                    JOIN MEMBERS on m.recommendedby = m.memid
                    """
